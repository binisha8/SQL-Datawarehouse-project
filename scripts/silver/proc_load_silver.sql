...
BEGIN
	...
	cst_material_status,
		CASE WHEN UPPER(TRIM(cst_material_status))='M' THEN 'Married'
				 ...
				 ELSE 'n/a'
		END cst_material_status, --Normalize marital status to readable format 
	cst_gndr,
	...
	cst_create_date
      FROM(
		...
		*,
		...
		WHERE selecting_last=1--SELECT the most recent per customer
...
-- Loading erp_loc_a101
		...
		CASE WHEN TRIM(cntry) = 'DE' THEN 'Germany'
			 ...
			 ELSE TRIM(cntry)--Normalizing and handling missing or blank country codes
		END AS cntry
